<template>
  <div>
    ...
    <div>
      <MdEditor :toolbars="toolbars" v-model="text">
        <template #defToolbars>
          ...
          <ModalToolbar title="PublishVideo" v-if="auth.level === 3">
            <!-- TODO 插入视频 -->
            <template #trigger>
      ...
      <div v-if="showBiliVideoModal" class="modal-overlay">
        <div class="modal-content">
          ...
          <div class="modal-actions">
            <button @click="showModal = false" class="modal-button modal-cancel">取消</button>
      ...
      <div v-if="showVideoModal" class="modal-overlay">
        <div class="modal-content">
          ...
          <textarea v-model="videoUrl" placeholder="输入视频地址" class="modal-input"></textarea>
          <textarea v-model="coverUrl" placeholder="输入视频封面" class="modal-input"></textarea>
          <div class="modal-actions">
            <button @click="showVideoModal = false" class="modal-button modal-cancel">取消</button>
            <button @click="insertVideo" class="modal-button modal-insert">插入视频</button>
          </div>
        </div>
        <div class="modal-backdrop" @click="showVideoModal = false"></div>
      </div>
    </div>
  </div>
</template>
